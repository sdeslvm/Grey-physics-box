...
protocol WebLoadable: AnyObject {
    var state: GreyPhysicsWebStatus { get set }
...
final class GreyPhysicsWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

  @Published var state: GreyPhysicsWebStatus = .standby
    ...
    func observeProgression() {
        progressPublisher
            ...
            .sink { [weak self] progress in
                ...
                let newState: GreyPhysicsWebStatus = progress < 1.0 ? .progressing(progress: progress) : .finished
...
extension GreyPhysicsWebLoader: WKNavigationDelegate {
...
extension GreyPhysicsWebLoader {
    ...
    func publish(_ newState: GreyPhysicsWebStatus) {
...
private extension GreyPhysicsWebLoader {
    func updateState(_ newState: GreyPhysicsWebStatus) {
