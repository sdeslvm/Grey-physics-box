...
final class GreyPhysicsOrientationManager {
    static let shared = GreyPhysicsOrientationManager()
...
final class GreyPhysicsAppDelegate: NSObject, UIApplicationDelegate {
    func application(
