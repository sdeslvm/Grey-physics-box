...
enum GreyPhysicsWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: GreyPhysicsWebStatus) -> Bool {
        switch (self, other) {
...
extension GreyPhysicsWebStatus {
...
extension GreyPhysicsWebStatus {
    static func == (lhs: GreyPhysicsWebStatus, rhs: GreyPhysicsWebStatus) -> Bool {
