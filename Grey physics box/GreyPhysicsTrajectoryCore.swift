...
struct GreyPhysicsGameInitialView: View {
    private var gameResourceURL: URL { URL(string: "https://greyphysbox.pro/profile")! }

    var body: some View {
        ZStack {
            Color(hex: "#000")
                .ignoresSafeArea()
            GreyPhysicsEntryScreen(loader: .init(resourceURL: gameResourceURL))
        }
    }
}
