...
final class GreyPhysicsBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: GreyPhysicsWebLoader
    private let coordinator: GreyPhysicsWebCoordinator
    ...
    init(
        ...
        loader: GreyPhysicsWebLoader,
        coordinator: GreyPhysicsWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        GreyPhysicsOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        GreyPhysicsOrientationManager.shared.currentMask
    }
    ...
    private func unlockOrientationIfNeeded() {
        ...
        GreyPhysicsOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension GreyPhysicsBaseWebViewController {
