...
class GreyPhysicsWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (GreyPhysicsWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (GreyPhysicsWebStatus) -> Void) {
